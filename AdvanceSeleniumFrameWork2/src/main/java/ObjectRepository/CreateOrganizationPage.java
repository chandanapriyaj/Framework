...
public class CreateOrganizationPage {
	//initilaztion
		 ...
		 * @param phoneNum
		 */
		public void enterOrgPhoneNum(String PhnNum)
		{
			organizationPhoneNum.sendKeys(PhnNum);
		}
		 ...
		 * @param Email
		 */
		public void enterOrgEmailId(String email)
		{
		 ...
		 * @param email
		 */
		  public void orgData(String OrgName,String PhnNum,String email)
		 {
			 organizationName.sendKeys(OrgName);
			 organizationPhoneNum.sendKeys(PhnNum);
			 organizationEmailId.sendKeys(email);
